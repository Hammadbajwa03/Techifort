    ...
    <section className="relative flex min-h-[42vh] items-end overflow-hidden pb-14 pt-28 sm:min-h-[48vh] sm:pb-16 sm:pt-32">
      ...
      <div className="container-padded relative z-10">
        ...
        >
          ...
          <span className="text-brand-200">About Us</span>
        </motion.nav>
        ...
        >
          A forward-thinking software development company dedicated to bringing
          innovative, reliable, and high-quality solutions to businesses across
          the globe.
        </motion.p>
      </div>
    </section>
