...
export function FAQHero() {
  return (
    <section className="relative flex min-h-[35vh] items-end overflow-hidden pb-14 pt-28 sm:min-h-[40vh] sm:pb-16 sm:pt-32">
      <AmbientStarfield />
      ...
      <div className="container-padded relative z-10">
        ...
        >
          ...
          <span className="text-brand-200">FAQs</span>
        </motion.nav>
        ...
        >
          Everything you need to know about working with Techifort — and if you
          don&apos;t find your answer here, our team is just a message away.
        </motion.p>
      </div>
    </section>
  );
