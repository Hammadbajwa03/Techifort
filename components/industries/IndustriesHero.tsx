    ...
    <section className="relative flex min-h-[40vh] items-end overflow-hidden pb-14 pt-28 sm:min-h-[45vh] sm:pb-16 sm:pt-32">
      ...
      <div className="container-padded relative z-10">
        ...
        >
          ...
          <span className="text-brand-200">Industries</span>
        </motion.nav>
        ...
        >
          From startups to enterprises, we build tailored software, AI, and
          digital solutions across 16+ industries — engineered around the
          real-world challenges each sector faces.
        </motion.p>
      </div>
    </section>
  );
