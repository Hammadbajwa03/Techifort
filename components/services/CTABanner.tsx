...
export function CTABanner({
  ...
  subtext = "Tell us your goals — we'll recommend the right mix of services and a clear first step.",
}: CTABannerProps) {
  return (
    <section className="relative overflow-hidden section-padding">
      ...
      <div className="container-padded relative z-10">
        <AnimateIn className="mx-auto max-w-2xl text-center">
          ...
          {subtext ? (
            <p className="mt-4 text-lg text-brand-100 sm:text-xl">{subtext}</p>
          ) : null}
          <Link
            href="/contact"
