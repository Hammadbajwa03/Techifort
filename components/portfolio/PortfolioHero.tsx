    ...
    <section className="relative flex min-h-[40vh] items-end overflow-hidden pb-14 pt-28 sm:min-h-[45vh] sm:pb-16 sm:pt-32">
      ...
      <div className="container-padded relative z-10">
        ...
        >
          ...
          <span className="text-brand-200">Portfolio</span>
        </motion.nav>
        ...
        >
          A showcase of platforms, products, and digital solutions we&apos;ve
          built for clients across development, consulting, finance, and
          branding.
        </motion.p>
      </div>
    </section>
